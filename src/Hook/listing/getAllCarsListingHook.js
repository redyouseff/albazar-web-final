...
const getAllCarsListingHook = (filters = {}) => {
    ...
    const processFilters = () => {
        ...
        Object.entries(filters).forEach(([key, value]) => {
            // Handle range filters (year, price, kilometers)
    ...
    useEffect(() => {
        const getListings = async () => {
            ...
            try {
                ...
                await dispatch(getAllListingsByCategory(CATEGORY_CAR_ID, queryParams));   
            } catch (err) {
...
export default getAllCarsListingHook; 